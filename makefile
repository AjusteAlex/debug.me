...
controller : ## Commande de création de controller
	@$(SYMFONY) make:controller

entity : ## Commande de création d'une entité
	@$(SYMFONY) make:entity
...
## —— Symfony BDD 🎵 ———————————————————————————————————————————————————————————————
create: ## Migration
	@$(SYMFONY_BIN) console d:d:c

migration: ## Migration
	@$(SYMFONY_BIN) console make:migration

migrate: ## Migrate
	@$(SYMFONY_BIN) console doctrine:migrations:migrate
